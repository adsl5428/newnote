...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx4014cebd3bd43dd6'),         // AppID
    'secret'  => env('WECHAT_SECRET', '32c24d54b9ed8dd6deb6ff05308049ac'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'lihongcheng'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'v0wrKwHg3KmFu5EoTVeZM0HMnL3CtxQ5S06Cgfv6lSu'),                    // EncodingAESKey
